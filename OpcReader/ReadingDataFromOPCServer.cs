...
namespace OpcReader
{
    public class ReadingDataFromOPCServer : BackgroundService
    {
        private readonly IDeviceRepository _deviceRepository;
        private readonly ITagRepository _tagRepository;
        private readonly ITagValueRepository _tagValueRepository;
        private Timer timer;
        private OpcClient client = new OpcClient("opc.tcp://192.168.0.104:55000");
        private readonly IHostApplicationLifetime _appLifetime;
        public ReadingDataFromOPCServer(
        ...
        private async Task ReadMetriks()
        {
            ...
            var devices = await _deviceRepository
                .GetAll()
                .Where(x=>x.Type== DataForwardingWeb.Domain.Enum.DeviceType.СOUNTER)
                .ToListAsync();
